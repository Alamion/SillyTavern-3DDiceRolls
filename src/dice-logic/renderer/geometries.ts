...
export default abstract class DiceGeometry {
    ...
    create(): this {
        ...
        debug(`DiceGeometry: Got ${materials.length} materials, geometry groups: ${geometry.groups.length}`)
    ...
    createTexture(index: number): Texture | null {
        ...
        let textStartX = this.textureSize / 2
...
export class D100DiceGeometry extends DiceGeometry {
